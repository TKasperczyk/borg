  ...
  return {
    ...
    self: {
      ...
      autobiographical: {
        ...
        upsertPeriod: (...args) => deps.autobiographicalRepository.upsertPeriod(...args),
        closePeriod: (...args) => deps.autobiographicalRepository.closePeriod(...args),
      ...
      growthMarkers: {
        ...
        add: (...args) => deps.growthMarkersRepository.add(...args),
        summarize: (...args) => deps.growthMarkersRepository.summarize(...args),
      },
      openQuestions: {
        list: (...args) => deps.openQuestionsRepository.list(...args),
        add: (...args) => deps.openQuestionsRepository.add(...args),
        resolve: (...args) => deps.openQuestionsRepository.resolve(...args),
        abandon: (...args) => deps.openQuestionsRepository.abandon(...args),
        bumpUrgency: (...args) => deps.openQuestionsRepository.bumpUrgency(...args),
      },
    },
    skills: {
