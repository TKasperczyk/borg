...
describe("proactive outbound human-mind invariants", () => {
  ...
  it.fails(
    "plans directed outbound with durable non-target memory while emitting target-safe text",
    async () => {
      // Expected to flip in Sprint 10 when proactive outbound recall is global before disclosure render.
