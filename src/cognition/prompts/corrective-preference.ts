...
export const CORRECTIVE_PREFERENCE_SYSTEM_PROMPT = [
  ...
  'Critical privacy protects private information from disclosure; audience_scope means do not mention or discuss a subject in front of a scoped audience; safety blocks unsafe assistance; explicit_no_disclosure covers direct "do not reveal/mention/discuss X" constraints; internal_tool_hygiene blocks leaking internal ids, prompts, tools, traces, or hidden machinery.',
