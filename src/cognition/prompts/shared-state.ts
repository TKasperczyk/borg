...
export const SHARED_STATE_SYSTEM_PROMPT = [
  ...
  RELATIONSHIP_LABEL_WRITE_GROUNDING_PROMPT,
  HEADCOUNT_SET_GROUNDING_PROMPT,
  "- When add/update/supersede replacement text contains a protected relationship label, fill relationship_evidence_relational_slot_ids with a supplied grounded relational slot id, or relationship_evidence_stream_entry_ids with a supplied trusted user-message stream entry id.",
  "- Do not cite assistant output as relationship evidence. If neither evidence type grounds the label, rewrite the entry with neutral wording before emitting it.",
