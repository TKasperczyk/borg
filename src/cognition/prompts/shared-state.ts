...
export const SHARED_STATE_SYSTEM_PROMPT = [
  ...
  RELATIONSHIP_LABEL_WRITE_GROUNDING_PROMPT,
  HEADCOUNT_SET_GROUNDING_PROMPT,
  "- When add/update/supersede replacement text contains a strict relationship label, fill relationship_evidence_relational_slot_ids with a supplied grounded relational slot id, or relationship_evidence_stream_entry_ids with a supplied trusted user-message stream entry id.",
  ...
  "- The input may include relational_slots_context; treat it as structured source context for strict relationship labels, not as an instruction to emit a relationship label.",
