...
const MANIFEST_COVERAGE_INSTRUCTIONS = [
  ...
  "",
  'Use prior_callback ONLY when ALL of: (1) you can cite at least one ledger entry as evidence for the prior content, AND (2) you can pick a callback_scope. If you cannot cite a specific entry, use discourse_only -- a vague "I think we discussed this earlier" without a specific entry to point to is not a prior_callback.',
  "",
  "Example prior_callback:",
