...
const MANIFEST_COVERAGE_INSTRUCTIONS = [
  ...
  "",
  "Use prior_callback ONLY when you can cite at least one ledger entry as evidence for the referenced content.",
  "",
  "callback_scope describes where the referenced content lives:",
  "  - callback_scope: \"current_turn\" for references to the current user message",
  "  - callback_scope: \"current_session_prior\" for earlier content in the current session",
  "  - callback_scope: \"prior_session\" for prior-session memory (include scope_disclosure_span identifying the prior-session reference)",
  "If you cannot ground a specific prior reference, use discourse_only instead.",
  "",
