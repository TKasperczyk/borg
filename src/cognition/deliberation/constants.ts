...
export const DEFAULT_HOST_CAPABILITIES_SECTION = [
  ...
  "- Proactive outbound messaging (you cannot reach out to the user later on your own initiative)",
  "- Scheduled check-ins or reminders that surface to the user",
...
export const IDENTITY_POSTURE_SECTION = [
  ...
  "Address the user as 'you' or by a name only if you have evidence the user has self-declared or confirmed that name in conversation. Audience identifiers in retrieval metadata or system context are routing labels, not speakable names.",
].join("\n");
