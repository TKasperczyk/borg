...
export type MetricsRow = {
  ...
  semantic_nodes_rejected_ungrounded_claim_count: number;
  semantic_nodes_rejected_ungrounded_claim_total: number;
  semantic_nodes_rejected_ungrounded_claim_by_label_family: Record<string, number>;
  shared_state_operations_rejected_ungrounded_claim_total: number;
  shared_state_operations_rejected_ungrounded_claim_by_label_family: Record<string, number>;
  commitment_candidates_rejected_ungrounded_claim_total: number;
  commitment_candidates_rejected_ungrounded_claim_by_label_family: Record<string, number>;
  ...
  closure_response_audit_failed_open_total: number;
  closure_pressure_mixed_observed_total: number;
  closure_pressure_closure_only_observed_total: number;
  ...
  shared_state_omitted_recent_entries_total_across_compiles: number;
  shared_state_omitted_live_recent_operational: number;
  shared_state_omitted_live_recent_operational_total_across_compiles: number;
  shared_state_omitted_live_recent_operational_final_compile: number;
  shared_state_omitted_live_recent_low_salience: number;
  shared_state_omitted_live_recent_low_salience_total_across_compiles: number;
  shared_state_omitted_live_recent_low_salience_final_compile: number;
  ...
  shared_state_omitted_locked_recent_total_across_compiles: number;
  shared_state_omitted_locked_recent_final_compile: number;
  shared_state_omitted_locked_old_total_across_compiles: number;
  shared_state_omitted_locked_old_final_compile: number;
  shared_state_omitted_locked_unknown_age_total_across_compiles: number;
  shared_state_omitted_locked_unknown_age_final_compile: number;
  shared_state_omitted_locked_with_active_critical_commitment_total_across_compiles: number;
  shared_state_omitted_locked_with_active_critical_commitment_final_compile: number;
  shared_state_omitted_locked_with_operational_canonicalizer_total_across_compiles: number;
  shared_state_omitted_locked_with_operational_canonicalizer_final_compile: number;
  shared_state_omitted_locked_indexed_only_total_across_compiles: number;
  shared_state_omitted_locked_indexed_only_final_compile: number;
  shared_state_omitted_pending: number;
  shared_state_omitted_pending_total_across_compiles: number;
  shared_state_omitted_pending_final_compile: number;
  shared_state_omitted_low_salience_live: number;
  shared_state_omitted_low_salience_live_final_compile: number;
  shared_state_omitted_dormant_live: number;
  shared_state_omitted_dormant_live_final_compile: number;
  shared_state_active_low_salience_live: number;
  shared_state_active_low_salience_live_final_compile: number;
  shared_state_active_dormant_live: number;
  shared_state_active_dormant_live_final_compile: number;
  shared_state_demoted_live_to_low_salience_total: number;
  shared_state_demoted_low_salience_to_dormant_total: number;
  shared_state_lifecycle_aging_demotable_total: number;
  shared_state_lifecycle_aging_demotable_final_compile: number;
  shared_state_lifecycle_aging_demoted_total: number;
  shared_state_lifecycle_aging_demoted_final_compile: number;
  shared_state_lifecycle_aging_blocked_by_current_turn_update_total: number;
  shared_state_lifecycle_aging_blocked_by_current_turn_update_final_compile: number;
  shared_state_lifecycle_aging_blocked_by_patch_touch_total: number;
  shared_state_lifecycle_aging_blocked_by_patch_touch_final_compile: number;
  shared_state_lifecycle_aging_blocked_by_ledger_overlap_total: number;
  shared_state_lifecycle_aging_blocked_by_ledger_overlap_final_compile: number;
  shared_state_lifecycle_aging_blocked_by_recent_retrieval_total: number;
  shared_state_lifecycle_aging_blocked_by_recent_retrieval_final_compile: number;
  shared_state_lifecycle_aging_blocked_by_active_canonicalizer_critical_total: number;
  shared_state_lifecycle_aging_blocked_by_active_canonicalizer_critical_final_compile: number;
  shared_state_lifecycle_aging_blocked_by_active_canonicalizer_operational_total: number;
  shared_state_lifecycle_aging_blocked_by_active_canonicalizer_operational_final_compile: number;
  shared_state_lifecycle_aging_blocked_by_hard_total: number;
  shared_state_lifecycle_aging_blocked_by_hard_final_compile: number;
  shared_state_lifecycle_aging_blocked_by_soft_total: number;
  shared_state_lifecycle_aging_blocked_by_soft_final_compile: number;
  shared_state_lifecycle_aging_unknown_age_total: number;
  shared_state_lifecycle_aging_unknown_age_final_compile: number;
  shared_state_lifecycle_aging_blocked_by_multiple_reasons_total: number;
  shared_state_lifecycle_aging_blocked_by_multiple_reasons_final_compile: number;
  shared_state_lifecycle_aging_low_salience_to_dormant_demotable_total: number;
  shared_state_lifecycle_aging_low_salience_to_dormant_demotable_final_compile: number;
  shared_state_lifecycle_aging_low_salience_to_dormant_demoted_total: number;
  shared_state_lifecycle_aging_low_salience_to_dormant_demoted_final_compile: number;
  shared_state_lifecycle_aging_low_salience_to_dormant_blocked_by_current_turn_update_total: number;
  shared_state_lifecycle_aging_low_salience_to_dormant_blocked_by_current_turn_update_final_compile: number;
  shared_state_lifecycle_aging_low_salience_to_dormant_blocked_by_patch_touch_total: number;
  shared_state_lifecycle_aging_low_salience_to_dormant_blocked_by_patch_touch_final_compile: number;
  shared_state_lifecycle_aging_low_salience_to_dormant_blocked_by_ledger_overlap_total: number;
  shared_state_lifecycle_aging_low_salience_to_dormant_blocked_by_ledger_overlap_final_compile: number;
  shared_state_lifecycle_aging_low_salience_to_dormant_blocked_by_recent_retrieval_total: number;
  shared_state_lifecycle_aging_low_salience_to_dormant_blocked_by_recent_retrieval_final_compile: number;
  shared_state_lifecycle_aging_low_salience_to_dormant_blocked_by_active_canonicalizer_critical_total: number;
  shared_state_lifecycle_aging_low_salience_to_dormant_blocked_by_active_canonicalizer_critical_final_compile: number;
  shared_state_lifecycle_aging_low_salience_to_dormant_blocked_by_active_canonicalizer_operational_total: number;
  shared_state_lifecycle_aging_low_salience_to_dormant_blocked_by_active_canonicalizer_operational_final_compile: number;
  shared_state_lifecycle_aging_low_salience_to_dormant_blocked_by_hard_total: number;
  shared_state_lifecycle_aging_low_salience_to_dormant_blocked_by_hard_final_compile: number;
  shared_state_lifecycle_aging_low_salience_to_dormant_blocked_by_soft_total: number;
  shared_state_lifecycle_aging_low_salience_to_dormant_blocked_by_soft_final_compile: number;
  shared_state_lifecycle_aging_low_salience_to_dormant_unknown_age_total: number;
  shared_state_lifecycle_aging_low_salience_to_dormant_unknown_age_final_compile: number;
  shared_state_lifecycle_aging_low_salience_to_dormant_blocked_by_multiple_reasons_total: number;
  shared_state_lifecycle_aging_low_salience_to_dormant_blocked_by_multiple_reasons_final_compile: number;
  shared_state_reactivated_low_salience_live_total: number;
  shared_state_reactivated_dormant_live_total: number;
  shared_state_at_cap_but_all_keys_indexed_compiles_total: number;
  shared_state_at_cap_with_operational_omission_compiles_total: number;
  shared_state_at_cap_with_cap_rejection_compiles_total: number;
