...
export type MetricsRow = {
  ...
  shared_state_lifecycle_aging_blocked_by_active_canonicalizer_total: number;
  shared_state_lifecycle_aging_blocked_by_active_canonicalizer_final_compile: number;
  ...
  shared_state_lifecycle_aging_low_salience_to_dormant_blocked_by_active_canonicalizer_total: number;
  shared_state_lifecycle_aging_low_salience_to_dormant_blocked_by_active_canonicalizer_final_compile: number;
