...
export function formatSimulatorReport(report: SimulatorRunReport): string {
  ...
  const lines = [
    ...
    `- Commitment gate rejections: protected relationship labels ${report.finalMetrics.commitment_candidates_rejected_ungrounded_label_total} total (${reportCountMap(report.finalMetrics.commitment_candidates_rejected_ungrounded_label_by_label)})`,
    "",
    ...
    `- Shared-state gate rejections: protected relationship labels ${report.finalMetrics.shared_state_operations_rejected_ungrounded_label_total} total (${reportCountMap(report.finalMetrics.shared_state_operations_rejected_ungrounded_label_by_label)})`,
    "",
