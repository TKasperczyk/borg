...
export function formatSimulatorReport(report: SimulatorRunReport): string {
  ...
  const lines = [
    ...
    `- Shared-state omission severity: live recent operational ${report.finalMetrics.shared_state_omitted_live_recent_operational}, live recent low-salience ${report.finalMetrics.shared_state_omitted_live_recent_low_salience}, live old ${report.finalMetrics.shared_state_omitted_live_old}, locked ${report.finalMetrics.shared_state_omitted_locked}, pending ${report.finalMetrics.shared_state_omitted_pending}, all active keys indexed ${report.finalMetrics.shared_state_all_active_keys_indexed}`,
