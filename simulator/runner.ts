...
export function formatSimulatorReport(report: SimulatorRunReport): string {
  ...
  const lines = [
    ...
    `  - blocked by: current_turn=${report.finalMetrics.shared_state_lifecycle_aging_blocked_by_current_turn_update_total}, patch_touch=${report.finalMetrics.shared_state_lifecycle_aging_blocked_by_patch_touch_total}, ledger_overlap=${report.finalMetrics.shared_state_lifecycle_aging_blocked_by_ledger_overlap_total}, recent_retrieval=${report.finalMetrics.shared_state_lifecycle_aging_blocked_by_recent_retrieval_total}, active_canonicalizer=${report.finalMetrics.shared_state_lifecycle_aging_blocked_by_active_canonicalizer_total}, multiple=${report.finalMetrics.shared_state_lifecycle_aging_blocked_by_multiple_reasons_total}`,
