...
export function formatSimulatorReport(report: SimulatorRunReport): string {
  ...
  const lines = [
    ...
    `- Shared-state omission severity: live recent operational ${report.finalMetrics.shared_state_omitted_live_recent_operational}, live recent low-salience ${report.finalMetrics.shared_state_omitted_live_recent_low_salience}, live old ${report.finalMetrics.shared_state_omitted_live_old}, low-salience ${report.finalMetrics.shared_state_omitted_low_salience_live}, dormant ${report.finalMetrics.shared_state_omitted_dormant_live}, locked ${report.finalMetrics.shared_state_omitted_locked}, pending ${report.finalMetrics.shared_state_omitted_pending}, all active keys indexed ${report.finalMetrics.shared_state_all_active_keys_indexed}`,
    `- Shared-state lifecycle: active low-salience ${report.finalMetrics.shared_state_active_low_salience_live}, active dormant ${report.finalMetrics.shared_state_active_dormant_live}, demoted live->low ${report.finalMetrics.shared_state_demoted_live_to_low_salience_total}, demoted low->dormant ${report.finalMetrics.shared_state_demoted_low_salience_to_dormant_total}, reactivated low ${report.finalMetrics.shared_state_reactivated_low_salience_live_total}, reactivated dormant ${report.finalMetrics.shared_state_reactivated_dormant_live_total}`,
